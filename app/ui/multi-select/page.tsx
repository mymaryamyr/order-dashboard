      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex p-1 rounded-md border min-h-10 h-auto w-full md:basis-[calc(33.333%-1rem)] flex-shrink-0 items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
              className
            )}
          >
